...
<p rel="noopener noreferrer" class="bg-gradient-to-l from-purple-700  p-2 font-bold rounded bg-blue-700 text-white"><?= $ct['priority'] ?></p>
    ...
    <div class="mb-8">
        ...
        <div class="shadow-xl my-8 flex h-14 justify-start items-center bg-blue-100 w-64 justify-between rounded-xl px-6">
            ...
            <div class="flex items-center">
                <img src="../img/<?= $ct['imagePath'] ?>" class="shadow-xl border-2 h-10 rounded-full mx-4" alt="">
    ...
    Assignment
    <div class="flex bg-gray-100 rounded my-8 p-2">
        <?php foreach ($result as $value) { ?>
        <div class="flex items-center m-4 bg-gray-300 p-2 rounded-xl shadow-xl border border-gray-400">
            <img src="../img/<?= $value['imagePath'] ?>" alt="user avatar" class="object-cover w-8 h-8 rounded-full bg-gray-500">
            <p class=" mx-2 text-gray-600"><?= $value['username'] ?></p>
        </div>
        <?php } ?>
    </div>
    ...
    <div class="mb-8">
        ...
        <!-- Comment form -->
            ...
            <div class="mb-8">
                ...
                <div class="flex">
                    <input id="comment" class="form-input mt-1 block w-96 border-2 px-6 py-2 rounded-md focus:ring-blue-500 focus:border-blue-500 "/>
                    <p id="commentBtn" class="m-2 bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 cursor-pointer w-36">Post Comment</p>
                    <input id="tkID" type="hidden" value="<?= $_POST['ticketId'] ?>">
                </div>
            </div>
