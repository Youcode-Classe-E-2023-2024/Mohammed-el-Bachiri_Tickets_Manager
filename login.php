...
<body>
<form action="controllers/User/UserLogin.php" method="post">
<div class="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
    <div class="relative py-3 sm:max-w-xl sm:mx-auto">
        <div
            class="bg-blue-500 absolute inset-0 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl">
        </div>
        <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
            ...
            <div class="max-w-md mx-auto">
                <div>
                    ...
                    <p class="text-red-400">
                        ...
                        } elseif (isset($_SESSION['login']) && $_SESSION['login'] === 'AccNotFound'){
            ...
            <div class="w-full flex justify-center">
                <button class="bg-blue-500 flex items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 hover:bg-blue-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    <span class="text-white">SUBMIT</span>
                </button>
            </div>
            <p class="mt-6" style="font-size: 12px;">Don't have an Account Yet ? <a href="register.php"><span class="text-blue-500 hover:opacity-70">Register</span></a></p>
        </div>
    </div>
</div>
</form>
